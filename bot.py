        ...
        for tweet in tweets:
            ...
            try:
                ...
                if s == False:
                    ...
                    api.update_status(
                        at_sign + ' عزیز برای این توییتر ربات رو اسپم تشخیص نده لطفا ربات رو فالو کنید و به همین پیام هر ریپلایی دوست داشتید بزنید تا ابر کلماتتون رو دریافت کنید.'+at_sign,
